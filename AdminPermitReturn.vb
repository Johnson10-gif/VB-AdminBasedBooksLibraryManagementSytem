...
Public Class AdminPermitReturn
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblTitle.Text = "PERMIT BOOK RETURN"
        ...
        Me.lblInfo.Text = "Select a pending return request and click 'Approve Return' to approve it."
        '
        'dgvRequests
        '
        ...
        'btnApprove
        '
        Me.btnApprove.BackColor = System.Drawing.Color.FromArgb(CType(CType(255, Byte), Integer), CType(CType(152, Byte), Integer), CType(CType(0, Byte), Integer))
    ...
    Private Sub LoadReturnRequests()
            ...
            Using conn As MySqlConnection = DatabaseHelper.GetConnection()
                ...
                Using cmd As New MySqlCommand(query, conn)
                    ...
                    If dgvRequests.Columns.Count > 0 Then
                        dgvRequests.Columns("ReturnRequestID").Visible = True
        ...
        Catch ex As Exception
            MessageBox.Show("Error loading return requests: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        Dim requestId As Integer = Convert.ToInt32(dgvRequests.SelectedRows(0).Cells("ReturnRequestID").Value)
        ...
        Dim result As DialogResult = MessageBox.Show("Approve return request?" & vbCrLf & vbCrLf &
                                                     "User: " & userName & vbCrLf &
                                                     "Book: " & bookTitle,
                                                     "Confirm Approval", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If result = DialogResult.Yes Then
            Try
                DatabaseHelper.ApproveReturnRequest(requestId)
